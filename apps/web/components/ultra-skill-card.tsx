  ...
  return (
    <div className="mt-10 min-w-0 max-w-full">
      {!hideHeading && (
        <>
          ...
          <p className="mt-1 text-sm leading-6 text-[var(--muted)]">
            Recommended: install the agent skill so your project can pick up future Ultra text refinements over time. It teaches any coding agent how to add Ultra HDR letterforms to headlines and logotypes.
          </p>
        </>
      )}
      <div className="mt-4 grid min-w-0 max-w-md grid-cols-2 gap-2 rounded-[var(--radius)] border border-[var(--border)] bg-[var(--panel)] px-3 py-3 sm:flex sm:items-center sm:px-4 sm:py-2">
        <code className="col-span-2 min-w-0 truncate font-mono text-xs sm:flex-1 sm:text-sm">npx skills add kirkstrobeck/gainmaps.com</code>
        <CopyButton text="npx skills add kirkstrobeck/gainmaps.com" label="Copy skill" className="justify-center sm:ml-2 sm:shrink-0" />
        <CopyButton text={ULTRA_HEADING_PROMPT} label="Copy prompt" className="justify-center sm:ml-2 sm:shrink-0" />
      </div>
      <p className="mt-2 max-w-md text-xs leading-5 text-[var(--muted)]">
        ...
        {" "}
        <a
          href="https://github.com/kirkstrobeck/gainmaps.com/tree/main/skills/ultra-text"
